    ...
    <div class="first">
        ...
        <div class="info">
          ...
          <form id="addToCartForm" method="post" action="cart.php">
              <input type="hidden" name="imagePath" value="./image/product/3.jpg">
              <input type="hidden" name="productName" value="BMW">
    ...
    <div class="other">
        ...
        <div class="cards">
            <div class="card" style="width: 18rem;">
                ...
                <img src="./image/product/4.jpg" class="card-img-top" alt="..." onclick="window.location.href = 'porsche.html'">
                <div class="card-body">
                  <h5 class="card-title">Card title</h5>
                  <p class="card-text">Some quick example text to build on the card title and make up the bulk of the card's content.</p>
